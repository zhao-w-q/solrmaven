...
<div class="banner_x center">
    <div class="search fl">
        ...
        <c:if test="${!empty loginUser}">
            <img src="${loginUser.icon}" alt="" style="width:80px;height:80px;float: right;margin:10px 40px 0 0">
        </c:if>
				<%--<a href="/login.jsp" class="login">
					去登录
				</a>--%>

    <%--<a href=""><div class="ad_top fr"></div></a>--%>
    <div class="nav fl">
        <ul>
            <li><a href="/list.jsp" target="_blank">小米手机</a></li>
            <li><a href="">红米</a></li>
                ...
                <div class="pop">
                    <div class="left fl">
                        <div>
                            ...
                            <div class="xuangou_right fr"><a href="/goods.jsp" target="_blank">选购</a></div>
                            <div class="clear"></div>
                        </div>
                        <div>
                            <div class="xuangou_left fl">
