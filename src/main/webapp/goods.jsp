...
<!-- end banner_x -->
	...
	<div class="jieshao mt20 w">
		...
		<div class="right fr">
			...
			<div class="mt20 ml20 xiadan">
				购买数量: <input type="number" style="width: 40px;height: 50px;" value="1">
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input class="jrgwc"  type="button" name="jrgwc" value="立即选购" id="toOrder"/>
				<input class="jrgwc" type="button" name="jrgwc" value="加入购物车" id="toCart"/>
			</div>
