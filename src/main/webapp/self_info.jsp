	...
	<!-- start header -->
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a href="/order.jsp">我的订单</a></div>
					<div class="fr">
						<ul>
	...
	<div class="grzxbj">
		...
		<div class="rtcont fr">
			<div class="grzlbt ml40">
				...
				<img src="/image/icon/a.png" alt="" style="width: 50px;height: 50px;margin-top:10px;cursor: pointer" id="icon">
			</div>
			...
			<div class="subgrzl ml40"><span>email</span><span>xxx@xxx.com</span><span><a href="">编辑</a></span></div>
			<div class="subgrzl ml40"><span>性别</span><span>男</span><span><a href="">编辑</a></span></div>
			<div class="subgrzl ml40"><span>生日</span><span>1990-10-10</span><span><a href="">编辑</a></span></div>
	...
	<script>
		...
		$(function () {
		    ...
		    $("#iconFile").change(function () {
                ...
                formData.append("iconFile", document.getElementById("iconFile").files[0]);
                $.ajax({
                    url:"/uploadServlet",
                    processData:false,
                    contentType : false,
